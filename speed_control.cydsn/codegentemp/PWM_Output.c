...
*
* \funcusage
*  \snippet PWM_Output_SUT.c usage_PWM_Output_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet PWM_Output_SUT.c usage_PWM_Output_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet PWM_Output_SUT.c usage_PWM_Output_Read  
*******************************************************************************/
...
* preferred PWM_Output_Read() API because the 
* PWM_Output_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet PWM_Output_SUT.c usage_PWM_Output_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: PWM_Output_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use PWM_Output_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - PWM_Output_0_INTR       (First pin in the list)
    *  - PWM_Output_1_INTR       (Second pin in the list)
    *  - ...
    *  - PWM_Output_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet PWM_Output_SUT.c usage_PWM_Output_SetInterruptMode
    *******************************************************************************/
    void PWM_Output_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & PWM_Output_0_INTR) != 0u) 
		{ 
			 PWM_Output_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet PWM_Output_SUT.c usage_PWM_Output_ClearInterrupt
    *******************************************************************************/
