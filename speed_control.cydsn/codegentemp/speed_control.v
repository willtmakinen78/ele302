// ======================================================================
// speed_control.v generated from TopDesign.cysch
// 02/28/2021 at 16:21
...
module CharLCD_v2_20_1 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("0ed09cfb-9387-402c-8ffa-c7a039d9ff67/ed092b9b-d398-4703-be89-cebf998501f6"),
...
`ifdef WARP
`define CY_BLK_DIR "C:\Program Files (x86)\Cypress\PSoC Creator\4.2\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\PulseConvert_v1_0"
`include "C:\Program Files (x86)\Cypress\PSoC Creator\4.2\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\PulseConvert_v1_0\PulseConvert_v1_0.v"
`else
`define CY_BLK_DIR "C:\Program Files (x86)\Cypress\PSoC Creator\4.2\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\PulseConvert_v1_0"
`include "C:\Program Files (x86)\Cypress\PSoC Creator\4.2\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\PulseConvert_v1_0\PulseConvert_v1_0.v"
`endif
...
module top ;
	...
	wire [0:0] tmpOE__Hall_net;
	wire [0:0] tmpIO_0__Hall_net;
	wire [0:0] tmpINTERRUPT_0__Hall_net;
	electrical [0:0] tmpSIOVREF__Hall_net;
	...
	cy_psoc3_pins_v1_10
		...
		Hall
		 (.oe(tmpOE__Hall_net),
		  .y({1'b0}),
		  .fb({Net_55}),
		  .io({tmpIO_0__Hall_net[0:0]}),
		  .siovref(tmpSIOVREF__Hall_net),
		  .interrupt({tmpINTERRUPT_0__Hall_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Hall_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};


    assign Net_85 = ~Net_55;
    ...
    Timer_v2_80_2 Counter (
        ...
        .tc(Net_67),
        .clock(Net_179));
    defparam Counter.CaptureCount = 2;
    defparam Counter.CaptureCounterEnabled = 0;
    defparam Counter.DeviceFamily = "PSoC5";
    defparam Counter.InterruptOnCapture = 0;
    defparam Counter.InterruptOnTC = 0;
    defparam Counter.Resolution = 16;
    defparam Counter.SiliconRevision = "0";


	cy_clock_v1_0
		#(.id("ae6e59eb-6c3b-4720-90d9-5ec03a20cda7"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("100000000000"),
		  .is_direct(0),
	...
	cy_clock_v1_0
		#(.id("5d60bc49-bf20-4126-a4e2-cd2980a3e6af"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_clock_v1_0
		#(.id("a66449c9-9097-4ef2-86ff-999396e2c94d"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("c5f253a8-10d5-4143-b567-d61e455508a1"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
