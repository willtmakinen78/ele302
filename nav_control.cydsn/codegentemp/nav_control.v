// ======================================================================
// nav_control.v generated from TopDesign.cysch
// 04/21/2021 at 14:34
...
// Comp_v2_0(Hysteresis=0, Pd_Override=0, Polarity=0, PSOC5A=false, Speed=0, Sync=0, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=Comp_v2_0, CY_CONFIG_TITLE=Threshold_Comparator, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Threshold_Comparator, CY_INSTANCE_SHORT_NAME=Threshold_Comparator, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=Threshold_Comparator, )
module Comp_v2_0_5 (
    Vplus,
    CmpOut,
    Vminus,
...
module top ;
	...
	cy_clock_v1_0
		#(.id("eb84b13c-6235-4d6c-b2c4-3170d1500f9e"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("775193798.449612"),
		  .is_direct(0),
		  .is_digital(1))
		Servo_Clk
		 (.clock_out(Net_635));
	...
	wire [0:0] tmpOE__SERVO_output_net;
	wire [0:0] tmpFB_0__SERVO_output_net;
	wire [0:0] tmpIO_0__SERVO_output_net;
	wire [0:0] tmpINTERRUPT_0__SERVO_output_net;
	electrical [0:0] tmpSIOVREF__SERVO_output_net;

	cy_psoc3_pins_v1_10
		#(.id("237d3492-d314-478b-a127-685f0206342f"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		SERVO_output
		 (.oe(tmpOE__SERVO_output_net),
		  .y({Net_952}),
		  .fb({tmpFB_0__SERVO_output_net[0:0]}),
		  .io({tmpIO_0__SERVO_output_net[0:0]}),
		  .siovref(tmpSIOVREF__SERVO_output_net),
		  .interrupt({tmpINTERRUPT_0__SERVO_output_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SERVO_output_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("84a356cf-0d8a-4d93-bf10-b3609a83a2a3"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    Comp_v2_0_5 Threshold_Comparator (
        .Vplus(Net_2695),
        .CmpOut(Net_2731),
        .Vminus(Net_2681),
        .clock(Net_2179));
	...
	wire [0:0] tmpOE__Composite_net;
	wire [0:0] tmpFB_0__Composite_net;
	wire [0:0] tmpIO_0__Composite_net;
	wire [0:0] tmpINTERRUPT_0__Composite_net;
	electrical [0:0] tmpSIOVREF__Composite_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("77715107-f8d5-47e5-a629-0fb83101ac6b"),
		  ...
		  .input_buffer_sel(2'b00))
		Composite
		 (.oe(tmpOE__Composite_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Composite_net[0:0]}),
		  .analog({Net_2681}),
		  .io({tmpIO_0__Composite_net[0:0]}),
		  .siovref(tmpSIOVREF__Composite_net),
		  .interrupt({tmpINTERRUPT_0__Composite_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Composite_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__H_Sync_net;
	wire [0:0] tmpIO_0__H_Sync_net;
	wire [0:0] tmpINTERRUPT_0__H_Sync_net;
	electrical [0:0] tmpSIOVREF__H_Sync_net;

	cy_psoc3_pins_v1_10
		#(.id("137f72af-07cb-48a0-b45d-11de5950070f"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		H_Sync
		 (.oe(tmpOE__H_Sync_net),
		  .y({1'b0}),
		  .fb({Net_2172}),
		  .io({tmpIO_0__H_Sync_net[0:0]}),
		  .siovref(tmpSIOVREF__H_Sync_net),
		  .interrupt({tmpINTERRUPT_0__H_Sync_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__H_Sync_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__V_Sync_net;
	wire [0:0] tmpIO_0__V_Sync_net;
	wire [0:0] tmpINTERRUPT_0__V_Sync_net;
	electrical [0:0] tmpSIOVREF__V_Sync_net;

	cy_psoc3_pins_v1_10
		#(.id("df866a21-4617-4cb1-9b11-81e235665ced"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		V_Sync
		 (.oe(tmpOE__V_Sync_net),
		  .y({1'b0}),
		  .fb({Net_2173}),
		  .io({tmpIO_0__V_Sync_net[0:0]}),
		  .siovref(tmpSIOVREF__V_Sync_net),
		  .interrupt({tmpINTERRUPT_0__V_Sync_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__V_Sync_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("1bfe233e-7dde-44a1-bad0-15bdef92f951"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_clock_v1_0
		#(.id("cf1750e8-a85e-43f6-a347-b8c1d6ff9731"),
		  .source_clock_id(""),
		  .divisor(0),
    ...
    CyControlReg_v1_80 Line_Time_Reset (
        .control_1(Net_2798),
        .control_2(Net_2799),
        .control_3(Net_2800),
        .control_0(Net_2511),
        ...
        .clock(1'b0),
        .reset(1'b0));
    defparam Line_Time_Reset.Bit0Mode = 0;
    defparam Line_Time_Reset.Bit1Mode = 0;
    defparam Line_Time_Reset.Bit2Mode = 0;
    defparam Line_Time_Reset.Bit3Mode = 0;
    defparam Line_Time_Reset.Bit4Mode = 0;
    defparam Line_Time_Reset.Bit5Mode = 0;
    defparam Line_Time_Reset.Bit6Mode = 0;
    defparam Line_Time_Reset.Bit7Mode = 0;
    defparam Line_Time_Reset.BitValue = 0;
    defparam Line_Time_Reset.BusDisplay = 0;
    defparam Line_Time_Reset.ExtrReset = 0;
    defparam Line_Time_Reset.NumOutputs = 1;

    Timer_v2_80_6 Line_Timer (
        .reset(Net_2511),
        .interrupt(Net_2870),
        .enable(1'b1),
        .trigger(1'b1),
        .capture(Net_2731),
        .capture_out(Net_2809),
        .tc(Net_2810),
        .clock(Net_2508));
    defparam Line_Timer.CaptureCount = 2;
    defparam Line_Timer.CaptureCounterEnabled = 0;
    defparam Line_Timer.DeviceFamily = "PSoC5";
    defparam Line_Timer.InterruptOnCapture = 0;
    defparam Line_Timer.InterruptOnTC = 0;
    defparam Line_Timer.Resolution = 16;
    defparam Line_Timer.SiliconRevision = "0";
	...
	wire [0:0] tmpOE__Out_Compare_net;
	wire [0:0] tmpFB_0__Out_Compare_net;
	wire [0:0] tmpIO_0__Out_Compare_net;
	wire [0:0] tmpINTERRUPT_0__Out_Compare_net;
	electrical [0:0] tmpSIOVREF__Out_Compare_net;

	cy_psoc3_pins_v1_10
		#(.id("6633ab9c-08fc-46b3-8c17-ffb6b6100e3b"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Out_Compare
		 (.oe(tmpOE__Out_Compare_net),
		  .y({Net_2876}),
		  .fb({tmpFB_0__Out_Compare_net[0:0]}),
		  .io({tmpIO_0__Out_Compare_net[0:0]}),
		  .siovref(tmpSIOVREF__Out_Compare_net),
		  .interrupt({tmpINTERRUPT_0__Out_Compare_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Out_Compare_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};


    assign Net_2876 = ~Net_2731;
	...
	wire [0:0] tmpOE__To_Pi_net;
	wire [0:0] tmpFB_0__To_Pi_net;
	wire [0:0] tmpIO_0__To_Pi_net;
	wire [0:0] tmpINTERRUPT_0__To_Pi_net;
	electrical [0:0] tmpSIOVREF__To_Pi_net;

	cy_psoc3_pins_v1_10
		#(.id("01f72141-cefb-4039-91e0-a89692b3879e"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		To_Pi
		 (.oe(tmpOE__To_Pi_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__To_Pi_net[0:0]}),
		  .io({tmpIO_0__To_Pi_net[0:0]}),
		  .siovref(tmpSIOVREF__To_Pi_net),
		  .interrupt({tmpINTERRUPT_0__To_Pi_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__To_Pi_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__From_Pi_net;
	wire [0:0] tmpIO_0__From_Pi_net;
	wire [0:0] tmpINTERRUPT_0__From_Pi_net;
	electrical [0:0] tmpSIOVREF__From_Pi_net;

	cy_psoc3_pins_v1_10
		#(.id("e31b63cf-c7d6-460c-8b67-76177d464d0a"),
		  .drive_mode(3'b011),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		From_Pi
		 (.oe(tmpOE__From_Pi_net),
		  .y({1'b0}),
		  .fb({Net_2943}),
		  .io({tmpIO_0__From_Pi_net[0:0]}),
		  .siovref(tmpSIOVREF__From_Pi_net),
		  .interrupt({tmpINTERRUPT_0__From_Pi_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__From_Pi_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};


    assign Net_2944 = ~Net_2943;
