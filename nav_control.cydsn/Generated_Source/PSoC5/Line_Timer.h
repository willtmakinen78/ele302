...
#if !defined(CY_TIMER_Line_Timer_H)
#define CY_TIMER_Line_Timer_H

#include "cytypes.h"
#include "cyfitter.h"
#include "CyLib.h" /* For CyEnterCriticalSection() and CyExitCriticalSection() functions */

extern uint8 Line_Timer_initVar;
...
#define Line_Timer_UsingFixedFunction         1u
...
#define Line_Timer_UsingHWEnable              0u
#define Line_Timer_EnableTriggerMode          0u
#define Line_Timer_InterruptOnCaptureCount    0u
#define Line_Timer_RunModeUsed                0u
#define Line_Timer_ControlRegRemoved          0u

#if defined(Line_Timer_TimerUDB_sCTRLReg_SyncCtl_ctrlreg__CONTROL_REG)
    #define Line_Timer_UDB_CONTROL_REG_REMOVED            (0u)
#elif  (Line_Timer_UsingFixedFunction)
    #define Line_Timer_UDB_CONTROL_REG_REMOVED            (0u)
#else 
    #define Line_Timer_UDB_CONTROL_REG_REMOVED            (1u)
#endif /* End Line_Timer_TimerUDB_sCTRLReg_SyncCtl_ctrlreg__CONTROL_REG */
...
#endif /* (!Line_Timer_UDB_CONTROL_REG_REMOVED) */
...
#define Line_Timer_INIT_CAPTURE_MODE       ((uint8)((uint8)1u << Line_Timer_CTRL_CAP_MODE_SHIFT))
#define Line_Timer_INIT_TRIGGER_MODE       ((uint8)((uint8)0u << Line_Timer_CTRL_TRIG_MODE_SHIFT))
#if (Line_Timer_UsingFixedFunction)
    #define Line_Timer_INIT_INTERRUPT_MODE (((uint8)((uint8)0u << Line_Timer_STATUS_TC_INT_MASK_SHIFT)) | \
                                                  ((uint8)((uint8)0 << Line_Timer_STATUS_CAPTURE_INT_MASK_SHIFT)))
#else
    #define Line_Timer_INIT_INTERRUPT_MODE (((uint8)((uint8)0u << Line_Timer_STATUS_TC_INT_MASK_SHIFT)) | \
                                                 ((uint8)((uint8)0 << Line_Timer_STATUS_CAPTURE_INT_MASK_SHIFT)) | \
                                                 ((uint8)((uint8)0 << Line_Timer_STATUS_FIFOFULL_INT_MASK_SHIFT)))
#endif /* (Line_Timer_UsingFixedFunction) */
#define Line_Timer_INIT_CAPTURE_COUNT      (2u)
#define Line_Timer_INIT_INT_CAPTURE_COUNT  ((uint8)((uint8)(1u - 1u) << Line_Timer_CTRL_INTCNT_SHIFT))
...
***************************************/
    ...
    ***************************************/
    ...
    #define Line_Timer_CTRL_ENABLE                        ((uint8)((uint8)0x01u << Line_Timer_CTRL_ENABLE_SHIFT))

    /* Control2 Register Bit Masks */
    /* As defined in Register Map, Part of the TMRX_CFG1 register */
    #define Line_Timer_CTRL2_IRQ_SEL_SHIFT                 0x00u
    #define Line_Timer_CTRL2_IRQ_SEL                      ((uint8)((uint8)0x01u << Line_Timer_CTRL2_IRQ_SEL_SHIFT))

    #if (CY_PSOC5A)
        /* Use CFG1 Mode bits to set run mode */
        /* As defined by Verilog Implementation */
        #define Line_Timer_CTRL_MODE_SHIFT                 0x01u
        #define Line_Timer_CTRL_MODE_MASK                 ((uint8)((uint8)0x07u << Line_Timer_CTRL_MODE_SHIFT))
    #endif /* (CY_PSOC5A) */
    #if (CY_PSOC3 || CY_PSOC5LP)
        ...
        #define Line_Timer_CTRL_RCOD_MASK  ((uint8)((uint8)0x03u << Line_Timer_CTRL_RCOD_SHIFT)) /* ROD and COD bit masks */
        #define Line_Timer_CTRL_ENBL_MASK  ((uint8)((uint8)0x80u << Line_Timer_CTRL_ENBL_SHIFT)) /* HW_EN bit mask */
        #define Line_Timer_CTRL_MODE_MASK  ((uint8)((uint8)0x03u << Line_Timer_CTRL_MODE_SHIFT)) /* Run mode bit mask */

        #define Line_Timer_CTRL_RCOD       ((uint8)((uint8)0x03u << Line_Timer_CTRL_RCOD_SHIFT))
        #define Line_Timer_CTRL_ENBL       ((uint8)((uint8)0x80u << Line_Timer_CTRL_ENBL_SHIFT))
    #endif /* (CY_PSOC3 || CY_PSOC5LP) */

    /*RT1 Synch Constants: Applicable for PSoC3 and PSoC5LP */
    #define Line_Timer_RT1_SHIFT                       0x04u
    /* Sync TC and CMP bit masks */
    #define Line_Timer_RT1_MASK                        ((uint8)((uint8)0x03u << Line_Timer_RT1_SHIFT))
    #define Line_Timer_SYNC                            ((uint8)((uint8)0x03u << Line_Timer_RT1_SHIFT))
    #define Line_Timer_SYNCDSI_SHIFT                   0x00u
    /* Sync all DSI inputs with Mask  */
    #define Line_Timer_SYNCDSI_MASK                    ((uint8)((uint8)0x0Fu << Line_Timer_SYNCDSI_SHIFT))
    /* Sync all DSI inputs */
    #define Line_Timer_SYNCDSI_EN                      ((uint8)((uint8)0x0Fu << Line_Timer_SYNCDSI_SHIFT))

    #define Line_Timer_CTRL_MODE_PULSEWIDTH            ((uint8)((uint8)0x01u << Line_Timer_CTRL_MODE_SHIFT))
    #define Line_Timer_CTRL_MODE_PERIOD                ((uint8)((uint8)0x02u << Line_Timer_CTRL_MODE_SHIFT))
    #define Line_Timer_CTRL_MODE_CONTINUOUS            ((uint8)((uint8)0x00u << Line_Timer_CTRL_MODE_SHIFT))
    ...
    /* As defined in Register Map, part of TMRX_SR0 register */
    #define Line_Timer_STATUS_TC_INT_MASK_SHIFT        (Line_Timer_STATUS_TC_SHIFT - 0x04u)
    /* As defined in Register Map, part of TMRX_SR0 register, Shared with Compare Status */
    #define Line_Timer_STATUS_CAPTURE_INT_MASK_SHIFT   (Line_Timer_STATUS_CAPTURE_SHIFT - 0x04u)

    /* Status Register Bit Masks */
    #define Line_Timer_STATUS_TC                       ((uint8)((uint8)0x01u << Line_Timer_STATUS_TC_SHIFT))
    #define Line_Timer_STATUS_CAPTURE                  ((uint8)((uint8)0x01u << Line_Timer_STATUS_CAPTURE_SHIFT))
    /* Interrupt Enable Bit-Mask for interrupt on TC */
    #define Line_Timer_STATUS_TC_INT_MASK              ((uint8)((uint8)0x01u << Line_Timer_STATUS_TC_INT_MASK_SHIFT))
    /* Interrupt Enable Bit-Mask for interrupt on Capture */
    #define Line_Timer_STATUS_CAPTURE_INT_MASK         ((uint8)((uint8)0x01u << Line_Timer_STATUS_CAPTURE_INT_MASK_SHIFT))
    ...
    ***************************************/
    ...
    #if(Line_Timer_Resolution <= 8u) /* 8-bit Timer */
        #define Line_Timer_CAPTURE_LSB         (* (reg8 *) Line_Timer_TimerUDB_sT16_timerdp_u0__F0_REG )
        #define Line_Timer_CAPTURE_LSB_PTR       ((reg8 *) Line_Timer_TimerUDB_sT16_timerdp_u0__F0_REG )
        #define Line_Timer_PERIOD_LSB          (* (reg8 *) Line_Timer_TimerUDB_sT16_timerdp_u0__D0_REG )
        #define Line_Timer_PERIOD_LSB_PTR        ((reg8 *) Line_Timer_TimerUDB_sT16_timerdp_u0__D0_REG )
        #define Line_Timer_COUNTER_LSB         (* (reg8 *) Line_Timer_TimerUDB_sT16_timerdp_u0__A0_REG )
        #define Line_Timer_COUNTER_LSB_PTR       ((reg8 *) Line_Timer_TimerUDB_sT16_timerdp_u0__A0_REG )
    #elif(Line_Timer_Resolution <= 16u) /* 8-bit Timer */
            ...
            #define Line_Timer_CAPTURE_LSB         (* (reg16 *) Line_Timer_TimerUDB_sT16_timerdp_u0__16BIT_F0_REG )
            #define Line_Timer_CAPTURE_LSB_PTR       ((reg16 *) Line_Timer_TimerUDB_sT16_timerdp_u0__16BIT_F0_REG )
            #define Line_Timer_PERIOD_LSB          (* (reg16 *) Line_Timer_TimerUDB_sT16_timerdp_u0__16BIT_D0_REG )
            #define Line_Timer_PERIOD_LSB_PTR        ((reg16 *) Line_Timer_TimerUDB_sT16_timerdp_u0__16BIT_D0_REG )
            #define Line_Timer_COUNTER_LSB         (* (reg16 *) Line_Timer_TimerUDB_sT16_timerdp_u0__16BIT_A0_REG )
            #define Line_Timer_COUNTER_LSB_PTR       ((reg16 *) Line_Timer_TimerUDB_sT16_timerdp_u0__16BIT_A0_REG )
        #endif /* CY_PSOC3 */
    #elif(Line_Timer_Resolution <= 24u)/* 24-bit Timer */
        #define Line_Timer_CAPTURE_LSB         (* (reg32 *) Line_Timer_TimerUDB_sT16_timerdp_u0__F0_REG )
        #define Line_Timer_CAPTURE_LSB_PTR       ((reg32 *) Line_Timer_TimerUDB_sT16_timerdp_u0__F0_REG )
        #define Line_Timer_PERIOD_LSB          (* (reg32 *) Line_Timer_TimerUDB_sT16_timerdp_u0__D0_REG )
        #define Line_Timer_PERIOD_LSB_PTR        ((reg32 *) Line_Timer_TimerUDB_sT16_timerdp_u0__D0_REG )
        #define Line_Timer_COUNTER_LSB         (* (reg32 *) Line_Timer_TimerUDB_sT16_timerdp_u0__A0_REG )
        #define Line_Timer_COUNTER_LSB_PTR       ((reg32 *) Line_Timer_TimerUDB_sT16_timerdp_u0__A0_REG )
    #else /* 32-bit Timer */
            ...
            #define Line_Timer_CAPTURE_LSB         (* (reg32 *) Line_Timer_TimerUDB_sT16_timerdp_u0__32BIT_F0_REG )
            #define Line_Timer_CAPTURE_LSB_PTR       ((reg32 *) Line_Timer_TimerUDB_sT16_timerdp_u0__32BIT_F0_REG )
            #define Line_Timer_PERIOD_LSB          (* (reg32 *) Line_Timer_TimerUDB_sT16_timerdp_u0__32BIT_D0_REG )
            #define Line_Timer_PERIOD_LSB_PTR        ((reg32 *) Line_Timer_TimerUDB_sT16_timerdp_u0__32BIT_D0_REG )
            #define Line_Timer_COUNTER_LSB         (* (reg32 *) Line_Timer_TimerUDB_sT16_timerdp_u0__32BIT_A0_REG )
            #define Line_Timer_COUNTER_LSB_PTR       ((reg32 *) Line_Timer_TimerUDB_sT16_timerdp_u0__32BIT_A0_REG )
        #endif /* CY_PSOC3 || CY_PSOC5 */ 
    #endif

    #define Line_Timer_COUNTER_LSB_PTR_8BIT       ((reg8 *) Line_Timer_TimerUDB_sT16_timerdp_u0__A0_REG )
    ...
    ***************************************/
    ...
    /* Control Register Bit Masks */
    #define Line_Timer_CTRL_INTCNT_MASK               ((uint8)((uint8)0x03u << Line_Timer_CTRL_INTCNT_SHIFT))
    #define Line_Timer_CTRL_TRIG_MODE_MASK            ((uint8)((uint8)0x03u << Line_Timer_CTRL_TRIG_MODE_SHIFT))
    #define Line_Timer_CTRL_TRIG_EN                   ((uint8)((uint8)0x01u << Line_Timer_CTRL_TRIG_EN_SHIFT))
    #define Line_Timer_CTRL_CAP_MODE_MASK             ((uint8)((uint8)0x03u << Line_Timer_CTRL_CAP_MODE_SHIFT))
    #define Line_Timer_CTRL_ENABLE                    ((uint8)((uint8)0x01u << Line_Timer_CTRL_ENABLE_SHIFT))
    ...
    #define Line_Timer_STATUS_TC_INT_MASK             ((uint8)((uint8)0x01u << Line_Timer_STATUS_TC_SHIFT))
    /* Interrupt Enable Bit-Mask */
    #define Line_Timer_STATUS_CAPTURE_INT_MASK        ((uint8)((uint8)0x01u << Line_Timer_STATUS_CAPTURE_SHIFT))
    /* NOT-Sticky FIFO Full Bit-Mask */
    #define Line_Timer_STATUS_FIFOFULL                ((uint8)((uint8)0x01u << Line_Timer_STATUS_FIFOFULL_SHIFT))
    /* NOT-Sticky FIFO Not Empty Bit-Mask */
    #define Line_Timer_STATUS_FIFONEMP                ((uint8)((uint8)0x01u << Line_Timer_STATUS_FIFONEMP_SHIFT))
    /* Interrupt Enable Bit-Mask */
    #define Line_Timer_STATUS_FIFOFULL_INT_MASK       ((uint8)((uint8)0x01u << Line_Timer_STATUS_FIFOFULL_SHIFT))
